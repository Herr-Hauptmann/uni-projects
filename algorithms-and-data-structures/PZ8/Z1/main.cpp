...
// Binarno stablo ubacivanje 2logn, dok kod niz mapa je O(n)
std::cout << "Binarno stablo mapa ubacivanje: " << ukvrijeme1/7500 << "ms, NizMapa ubacivanje: " << ukvrijeme2/750 << " ms" << std::endl;
