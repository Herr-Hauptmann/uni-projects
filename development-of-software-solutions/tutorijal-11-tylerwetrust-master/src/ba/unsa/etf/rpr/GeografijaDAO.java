...
public class GeografijaDAO{
    ...
    private GeografijaDAO()  {
        ...
        try {
            ...
            glavniGradUpit=conn.prepareStatement("SELECT grad.id, grad.naziv, grad.broj_stanovnika, grad.drzava, grad.slika,grad.postanski_broj FROM grad, drzava WHERE grad.drzava=drzava.id AND drzava.naziv=?");
            dajDrzavuUpit = conn.prepareStatement("SELECT * FROM drzava WHERE id=?");
    ...
    private Grad dajGradIzResultSeta(ResultSet rs) throws SQLException {
        Grad grad = new Grad(rs.getInt(1), rs.getString(2), rs.getInt(3), null, rs.getString(5),rs.getInt(6));
    ...
    public void dodajGrad(Grad grad){
        try {
            ...
            dodajGradUpit.setString(5, grad.getSlikaPath());
    ...
    public void izmijeniGrad(Grad grad){
        try {
            ...
            promijeniGradUpit.setString(5,grad.getSlikaPath());
            promijeniGradUpit.setInt(6,grad.getPostanskiBroj());
